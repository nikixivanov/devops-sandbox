...
### Lab 1: Manual Multi-OS Provisioning (CentOS Stream 9 and Ubuntu Jammy)
...
#### Lab Steps and Completed Objectives
...
### Lab 2: Automated Multi-OS Provisioning via Git Bash and Vagrant
...
*(Провлачете и пуснете скрийншота на VirtualBox тук)*

##### SSH Access via Git Bash Terminal
*(Провлачете и пуснете скрийншота на Git Bash тук)*
